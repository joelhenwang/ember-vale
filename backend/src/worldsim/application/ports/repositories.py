...
class InterventionRepository(Protocol):
    ...
    async def get_intervention(self, intervention_id: UUID) -> Intervention: ...
    ...
    async def save_step(
        self, step: InterventionStep, expected_version: int
    ) -> InterventionStep: ...


class ConditionRepository(Protocol):
    async def add_condition(self, condition: WorldCondition) -> None: ...
    async def get_condition(self, condition_id: UUID) -> WorldCondition: ...
...
class StoryRepository(Protocol):
    """Catalog entries, setup snapshots, drafts, and creation receipts."""
...
class PresetRepository(Protocol):
    """Immutable preset revisions with version-checked metadata."""
    ...
    async def delete_editor_draft(self, draft_id: UUID, expected_version: int) -> None: ...
    async def add_publication(self, receipt: EditorPublication) -> None: ...
    async def get_publication(self, draft_id: UUID) -> EditorPublication | None: ...
    async def delete_publications_for_draft(self, draft_id: UUID) -> None: ...


class SettingsRepository(Protocol):
    """Provider connections, pinned profile revisions, operator preferences."""
