...
ROUTES = (
    ...
    ("post", "/api/v1/library/presets/{preset_id}/editor-drafts", "openEditorDraft"),
    (
        "get",
        "/api/v1/library/presets/{preset_id}/editor-drafts/current",
        "readEditorDraft",
    ),
    (
        "patch",
        "/api/v1/library/presets/{preset_id}/editor-drafts/{draft_id}",
        "saveEditorDraft",
    ),
    (
        "delete",
    ...
    (
        "post",
        "/api/v1/library/presets/{preset_id}/editor-drafts/{draft_id}/publish",
        "publishEditorDraft",
    ),
    (
        "post",
        "/api/v1/library/presets/{preset_id}/editor-drafts/{draft_id}/complete",
        "completeEditorDraft",
    ),
